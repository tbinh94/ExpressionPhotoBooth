...
public class ConceptAdapter extends RecyclerView.Adapter<ConceptAdapter.ConceptViewHolder> {
    ...
    private FrameAdapter.OnFrameClickListener frameClickListener; // Thêm biến lưu bộ đàm

    // Nhận bộ đàm từ Activity
    ...
    public void onBindViewHolder(@NonNull ConceptViewHolder holder, int position) {
        ...
        // Truyền tiếp bộ đàm cho FrameAdapter
    ...
    @Override
    public int getItemCount() { return conceptList != null ? conceptList.size() : 0; }
